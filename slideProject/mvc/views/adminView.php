                  ...
                  <!-- Sidebar -->
                    <nav id="sidebar">
                        ...
                        <div class="row">
                            <div class="list-group col-12">
                                <a href="/slideProject/CategoryController" class="list-group-item "><i class="fa fa-bars" aria-hidden="true"></i> Categories</a>
                                <a href="/slideProject/ProductController" class="list-group-item"><i class="fa fa-product-hunt" aria-hidden="true"></i> Products</a>
                                <a href="/slideProject/UserController" class="list-group-item"><i class="fa fa-user" aria-hidden="true"></i> Users</a>
                            </div>                            
                        </div>              
                    </nav>
            </div>
                    <div class="col-md-9" id="content">
                        <?php 
                            ...
                            if (isset($data['pageEditCategory'])) {
                                require_once "pages/" . $data['pageEditCategory'] . ".php";
                            }

                            if (isset($data['pageProduct'])) {
                                require_once "pages/" . $data['pageProduct'] . ".php";
                            }

                            if (isset($data['pageAddProduct'])) {
                                require_once "pages/" . $data['pageAddProduct'] . ".php";
                            }

                            if (isset($data['pageEditProduct'])) {
                                require_once "pages/" . $data['pageEditProduct'] . ".php";
                            }
                        ?>
                    </div>
            <!--end-->
