<script>
        ...
        {
            return confirm ('Bạn có muốn xóa danh mục ' + categoryName + ' không ?');
        }
    </script>
<div class="container-fluid" >
    ...
    <table class="table table-bordered table-striped" id="table">
        ...
        <br/>
        <div id="add-category">
            <a href="/slideProject/CategoryController/add"><button type="submit" style="background-color: #507298;" class="btn btn-primary">Add CATEGORY</button></a>
        </div>
        <br/>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="/slideProject/CategoryController/getOne/<?php echo $listCategory['id']; ?>"><input class="btn btn-primary" style="width: 80px;" value="Edit"></a>
                    <a onclick="return deleteCategory('<?php echo $listCategory['categoryName']; ?>')" href="/slideProject/CategoryController/deleteCategory/<?php echo $listCategory['id']; ?>"><input class="btn btn-danger" style="width: 80px;" value="Delete"></a>
                </td>
            </tr>
            <?php
                }
