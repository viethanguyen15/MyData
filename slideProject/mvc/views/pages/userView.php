    <script>
        ...
        {
            return confirm ('Bạn có muốn xóa user ' + userId + ' không ?');
        }
    </script>
    ...
    <table class="table table-bordered table-striped" id="table">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="/slideProject/UserController/getOne/<?php echo $values['id']; ?>"><input class="btn btn-primary" style="width: 80px;" value="Edit"></a><br><br>
                    <a onclick="return deleteUser('<?php echo $values['userName']; ?>')" href="/slideProject/UserController/deleteUser/<?php echo $values['id']; ?>"><input class="btn btn-danger" style="width: 80px;" value="Delete"></a>
                </td>
            </tr>
            <?php
                }
